...
import locale from "@/locales/terminos.json";
		...
		<article className="max-w-5xl mx-auto px-6 sm:px-12 py-6 pb-20">
			...
			<section>
				...
				<p className="text-pretty mt-2">
					{locale.INFORMACION_RECOPILADA.CONTENIDO}
				</p>
			</section>
			...
			<section>
				...
				<p className="text-pretty mt-2">
					{locale.USO_DE_LA_INFORMACION.CONTENIDO}
				</p>
			</section>
			...
			<section>
				...
				<p className="text-pretty mt-2">
					{locale.CAMBIOS_EN_LA_POLITICA.CONTENIDO}
				</p>
			</section>
		</article>
	);
