...
export function YearBookStudent({
	...
	return (
		<Card
			radius="sm"
			shadow="none"
			className="xss:h-[16.5rem] sm:h-[20rem] xs:max-h-[320px] xl:max-h-[none] max-h-[335px] max-w-[220px] w-full m-auto sm:p-2 bg-default-100 "
		>
				...
				{student && (
					<>
						{TechIcons.map((iconItem) => {
							...
							const tecnica = i18n.TECHS.find((item) => item.ID === cellValue);
